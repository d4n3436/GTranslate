...
public sealed class LanguageDictionary : ILanguageDictionary<string, Language>
{
    ...
    private readonly IReadOnlyDictionary<string, Language> _languages = new ReadOnlyDictionary<string, Language>(new Dictionary<string, Language>
    {
        ...
        ["zh-TW"] = new("Chinese Traditional", "zh-TW", "zho-TW", TranslationServices.Google | TranslationServices.Bing | TranslationServices.Microsoft),
        ...
        ["ku"] = new("Kurdish (Central)", "ku", "kur", TranslationServices.Google | TranslationServices.Bing | TranslationServices.Microsoft),
        ["ky"] = new("Kyrgyz", "ky", "kir", TranslationServices.Google | TranslationServices.Yandex | TranslationServices.Microsoft),
        ["lo"] = new("Lao", "lo", "lao"),
        ...
        ["mn"] = new("Mongolian", "mn", "mon"),
        ["ne"] = new("Nepali", "ne", "nep"),
        ["no"] = new("Norwegian", "no", "nor"),
        ["or"] = new("Odia", "or", "ori", TranslationServices.Google | TranslationServices.Bing | TranslationServices.Microsoft),
        ["ps"] = new("Pashto", "ps", "pus", TranslationServices.Google | TranslationServices.Bing | TranslationServices.Microsoft),
        ...
        ["sm"] = new("Samoan", "sm", "smo", TranslationServices.Google | TranslationServices.Bing | TranslationServices.Microsoft),
        ...
        ["tk"] = new("Turkmen", "tk", "tuk", TranslationServices.Google | TranslationServices.Bing | TranslationServices.Microsoft),
        ["uk"] = new("Ukrainian", "uk", "ukr"),
        ["ur"] = new("Urdu", "ur", "urd"),
        ["ug"] = new("Uyghur", "ug", "uig", TranslationServices.Google | TranslationServices.Bing | TranslationServices.Microsoft),
        ["uz"] = new("Uzbek", "uz", "uzb"),
        ...
        ["as"] = new("Assamese", "as", "asm", TranslationServices.Bing | TranslationServices.Microsoft),
        ["yue"] = new("Cantonese", "yue", "yue", TranslationServices.Bing | TranslationServices.Microsoft),
        ["lzh"] = new("Chinese (Literary)", "lzh", "lzh", TranslationServices.Bing | TranslationServices.Microsoft),
        ["prs"] = new("Dari", "prs", "prs", TranslationServices.Bing | TranslationServices.Microsoft),
        ["dv"] = new("Divehi", "dv", "div", TranslationServices.Bing | TranslationServices.Microsoft),
        ["fj"] = new("Fijian", "fj", "fij", TranslationServices.Bing | TranslationServices.Microsoft),
        ["fil"] = new("Filipino", "fil", "fil", TranslationServices.Bing | TranslationServices.Microsoft),
        ["fr-CA"] = new("French (Canada)", "fr-CA", "fr-CA", TranslationServices.Bing | TranslationServices.Microsoft),
        ["mww"] = new("Hmong Daw", "mww", "mww", TranslationServices.Bing | TranslationServices.Microsoft),
        ["ikt"] = new("Inuinnaqtun", "ikt", "ikt", TranslationServices.Bing | TranslationServices.Microsoft),
        ["iu"] = new("Inuktitut", "iu", "iku", TranslationServices.Bing | TranslationServices.Microsoft),
        ["iu-Latn"] = new("Inuktitut (Latin)", "iu-Latn", "iu-Latn", TranslationServices.Bing | TranslationServices.Microsoft),
        ["mn-Mong"] = new("Mongolian (Traditional)", "mn-Mong", "mn-Mong", TranslationServices.Bing | TranslationServices.Microsoft),
        ["pt-PT"] = new("Portuguese (Portugal)", "pt-PT", "pt-PT", TranslationServices.Bing | TranslationServices.Microsoft),
        ["otq"] = new("Querétaro Otomi", "otq", "otq", TranslationServices.Bing | TranslationServices.Microsoft),
        ["sr-Latn"] = new("Serbian (Latin)", "sr-Latn", "srp-Latn", TranslationServices.Bing | TranslationServices.Microsoft),
        ["ty"] = new("Tahitian", "ty", "tah", TranslationServices.Bing | TranslationServices.Microsoft),
        ["bo"] = new("Tibetan", "bo", "bod", TranslationServices.Bing | TranslationServices.Microsoft),
        ["ti"] = new("Tigrinya", "ti", "tir", TranslationServices.Bing | TranslationServices.Microsoft),
        ["to"] = new("Tongan", "to", "ton", TranslationServices.Bing | TranslationServices.Microsoft),
        ["tlh"] = new("Klingon", "tlh", "tlh", TranslationServices.Bing | TranslationServices.Microsoft),
        ["kmr"] = new("Kurdish (Northern)", "kmr", "kmr", TranslationServices.Bing | TranslationServices.Microsoft),
        ["yua"] = new("Yucatec Maya", "yua", "yua", TranslationServices.Bing | TranslationServices.Microsoft),

        ["ba"] = new("Bashkir", "ba", "bak", TranslationServices.Bing | TranslationServices.Microsoft | TranslationServices.Yandex),
        ["cv"] = new("Chuvash", "cv", "chv", TranslationServices.Yandex),
        ["mhr"] = new("Eastern Mari", "mhr", "mhr", TranslationServices.Yandex),
        ["emj"] = new("Emoji", "emj", "emj", TranslationServices.Yandex), // Not present in Yandex.Cloud
        ["kazlat"] = new("Kazakh (Latin)", "kazlat", "kazlat", TranslationServices.Yandex),
        ["pap"] = new("Papiamento", "pap", "pap", TranslationServices.Yandex),
        ["sjn"] = new("Sindarin", "sjn", "sjn", TranslationServices.Yandex), // Not present in Yandex.Cloud
        ...
        ["tlh-Piqd"] = new("Klingon (pIqaD)", "tlh-Piqd", "tlh-Piqd", TranslationServices.Microsoft) // For some reason Bing stopped supporting this language, ty Microsoft
    });
}