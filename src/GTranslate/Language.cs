...
namespace GTranslate
{
    ...
    public sealed class Language : ILanguage, IEquatable<Language>
    {
        ...
        public Language(string nameOrCode)
        {
            ...
            {
                throw new ArgumentNullException(nameof(nameOrCode));
            }

            if (!TryGetLanguage(nameOrCode, out var language))
            {
                throw new ArgumentException("Unknown language.", nameof(nameOrCode));
            }
        ...
        /// </summary>
        public static LanguageDictionary LanguageDictionary { get; } = new LanguageDictionary();
