...
internal static class JsonElementExtensions
{
    ...
    public static JsonElement GetPropertyOrDefault(this JsonElement element, ReadOnlySpan<byte> propertyName)
    ...
    public static bool TryGetInt32(this JsonElement element, ReadOnlySpan<byte> propertyName, out int value)
    {
        value = 0;
    ...
    public static bool TryGetSingle(this JsonElement element, ReadOnlySpan<byte> propertyName, out float value)
    {
        value = 0;
        var prop = element.GetPropertyOrDefault(propertyName);
